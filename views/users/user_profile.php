...
<body class="">
    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li>
            <a href="/views/notifications.html">
              <i class="tim-icons icon-bell-55"></i>
              <p>Notifications</p>
            </a>
          </li>
          <li class="active ">
            <a href="/views/users/user_profile.php">
              <i class="tim-icons icon-single-02"></i>
              <p>User Profile</p>
            </a>
          </li>
          <li>
            <a href="/views/tables.html">
              <i class="tim-icons icon-puzzle-10"></i>
              <p>Table List</p>
            </a>
          </li>
          <li>
            <a href="/views/typography.html">
              <i class="tim-icons icon-align-center"></i>
              <p>Typography</p>
            </a>
          </li>
          <li>
            <a href="/views/rtl.html">
              <i class="tim-icons icon-world"></i>
              <p>RTL Support</p>
            </a>
          </li>
          <li class="active-pro">
            <a href="/views/upgrade.html">
                ...
                <p class="card-text">
                  <div class="author">
                    ...
                    <a href="javascript:void(0)">
                      <img class="avatar" src="/views/assets/img/emilyz.jpg" alt="...">
  ...
  <script src="/views/assets/js/black-dashboard.min.js?v=1.0.0"></script><!-- Black Dashboard DEMO methods, don't include it in your project! -->
